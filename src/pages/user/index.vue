<template>
    <div class="user">
        ...
        <div class="left">
            <div class="top">
                <svg t="1721874792172" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="6112" width="22" height="22">
                    <path
            ...
            <el-menu :default-active="$route.path" class="el-menu-vertical-demo" router>
                <el-menu-item index="/user/certification" @click="changeMenu('/user/certification')">
                    ...
                    <span class="context">实名认证</span>
                </el-menu-item>
                <el-menu-item index="/user/order" @click="changeMenu('/user/order')">
                    <el-icon>
                        <document />
                    </el-icon>
                    <span class="context">挂号订单</span>
                </el-menu-item>
                <el-menu-item index="/user/patient" @click="changeMenu('/user/patient')">
                    <el-icon>
                        <Setting />
                    </el-icon>
                    <span class="context">就诊人管理</span>
                </el-menu-item>
                <el-menu-item index="/user/profile" @click="changeMenu('/user/profile')">
                    <el-icon>
                        <SetUp />
                    </el-icon>
                    <span class="context">账号信息</span>
                </el-menu-item>
                <el-menu-item index="/user/comment" @click="changeMenu('/user/comment')">
                    <el-icon>
                        <ChatLineSquare />
                    </el-icon>
                    <span class="context">意见反馈</span>
                </el-menu-item>
            </el-menu>
        </div>
        <div class="right">
